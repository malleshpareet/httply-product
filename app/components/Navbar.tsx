...
export default function Navbar() {
  ...
  const links = [
    { href: process.env.NEXT_PUBLIC_WEB_APP_URL || "https://httply.qzz.io", label: "Web App", external: true },
  ...
  return (
    <nav
      id="navbar"
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "glass border-b border-white/[0.06]" : ""
        }`}
    >
